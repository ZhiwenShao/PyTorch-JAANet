...
if __name__ == '__main__':
    ...
    parser.add_argument('--bp4d_au_num', type=int, default=12, help='number of AUs for BP4D dataset')
    ...
    parser.add_argument('--pretrain_epoch', type=int, default=5, help='pretraining epoch')
    ...
    parser.add_argument('--pretrain_path', type=str, default='JAAv1_combine_1_3')
    parser.add_argument('--unit_dim', type=int, default=8, help='unit dims')
    parser.add_argument('--run_name', type=str, default='JAAv1_DISFA')
