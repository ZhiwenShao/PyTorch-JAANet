...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_name', type=str, default='/JAA_v1')
    ...
    parser.add_argument('--train_path_prefix', type=str, default='data/list/v6/BP4D_combine_1_2')
    parser.add_argument('--test_path_prefix', type=str, default='data/list/v6/BP4D_part3')
