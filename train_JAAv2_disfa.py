...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain_epoch', type=int, default=4, help='pretraining epoch')
    ...
    parser.add_argument('--pretrain_path', type=str, default='JAAv2_combine_1_3')
    parser.add_argument('--unit_dim', type=int, default=8, help='unit dims')
    parser.add_argument('--run_name', type=str, default='JAAv2_DISFA')
